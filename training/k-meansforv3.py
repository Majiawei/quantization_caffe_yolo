...
def compute_centroids(label_path,n_anchors,loss_convergence,grid_size,iterations_num,plus):
    ...
    for label_file in label_files:
        ...
        for line in f:
            ...
            if len(temp) > 1:
                ...
                num_boxes+=1
                print(str(num_boxes)+": "+line)

    if plus:
        centroids = init_centroids(boxes, n_anchors)
    else:
        # randomly choice n boxes from boxes as ori anchors
    ...
    for centroid in centroids:
        print("k-means result：\n")
        print(int(centroid.w * grid_size * 32),int(centroid.h * grid_size * 32))


label_path = "/home/user/Work/mjw/yolo-master/CarplateInCar/carplate_train.txt"
n_anchors = 6
